...
`},94779:function(e,n,t){t.r(n),t.d(n,{StandardSignAndSendTransactionScreen:function(){return V},default:function(){return V}});var r=t(57437),i=t(2265),a=t(3848),o=t(4696),s=t(72172),c=t(71554),l=t(48723),d=t(75168),u=t(1442),p=t(1801),f=t(15383),m=t(60683),g=t(97757),h=t(8557),x=t(60729),y=t(10900),v=t(3382),b=t(50640),w=t(58100),k=t(60164),S=t(12888),j=t(1013),A=t(77828);function z(e){return Object.freeze({executable:e.executable,lamports:e.lamports,programAddress:e.owner,space:e.space})}async function C(e,n,t={}){let{abortSignal:r,...i}=t;return(await e.getMultipleAccounts(n,{...i,encoding:"jsonParsed"}).send({abortSignal:r})).value.map((e,t)=>e&&"object"==typeof e&&"parsed"in e.data?function(e,n){if(!n)return Object.freeze({address:e,exists:!1});let t=n.data.parsed.info||{};return(n.data.program||n.data.parsed.type)&&(t.parsedAccountMeta={program:n.data.program,type:n.data.parsed.type}),Object.freeze({...z(n),address:e,data:t,exists:!0})}(n[t],e):function(e,n){if(!n)return Object.freeze({address:e,exists:!1});let t=(0,A.tA)().encode(n.data[0]);return Object.freeze({...z(n),address:e,data:t,exists:!0})}(n[t],e))}async function I(e,n,t){if(0===e.length)return{};let r=await C(n,e,t);return!function(e){let n=e.filter(e=>(!("exists"in e)||"exists"in e&&e.exists)&&e.data instanceof Uint8Array);if(n.length>0){let e=n.map(e=>e.address);throw new j.g1$(j.L25,{addresses:e})}}(r),!function(e){let n=e.filter(e=>!e.exists);if(n.length>0){let e=n.map(e=>e.address);throw new j.g1$(j.SH6,{addresses:e})}}(r),r.reduce((e,n)=>({...e,[n.address]:n.data.addresses}),{})}var E=t(93182),T=t(49437),$=t(80811),F=t(36672);t(29155),t(87336),t(97048),t(64131),t(35514);let L=p.zo.span`
  && {
    width: 82px;
    height: 82px;
    border-width: 4px;
